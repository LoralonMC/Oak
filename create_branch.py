...
"""
    ...
    print(f"\n  {branch_folder}/")
    print(f"  ├── __init__.py       (empty)")
    print(f"  ├── branch.yml        (manifest)")
    print(f"  ├── branch.py         (OakBranch subclass)")
    print(f"  ├── config.yml        (runtime config)")
    print(f"  └── data.db           (auto-created on first run)")
